...
Testing was time-boxed to 15 minutes per session to preserve cognitive performance. The evaluation apparatus pipeline utilized:
...
**Participant 1 — Task 1:** "This is pretty clear, I can see the pets straight away... I'll click on this one... okay, applying looks simple enough."

**Participant 1 — Task 2:** "I can see the 'Admin Portal' link in the top menu navigation structure, but once I land on the login page, the stark layout shift makes me feel like I have left the core application entirely." *(logs in)* "Okay, I want to delete this one... wait, I almost clicked Edit instead, they're right next to each other."

**Participant 2 — Task 1:** "Yep, found the pet I want, the form's pretty straightforward."

**Participant 2 — Task 2:** *(after logging in)* "This table's a lot to take in at once... trying to delete this entry now... oop, nearly hit Edit again. These two need more space between them."
